...
# train
python main.py -d ICEWS18 --history_len 4 --num_head 4 --num_ly 3 --topk 30 --decay 1e-4 --gpu 5 --test 0
#
# test
python main.py -d ICEWS18 --history_len 4 --num_head 4 --num_ly 3 --topk 30 --decay 1e-4 --gpu 5 --test 1
