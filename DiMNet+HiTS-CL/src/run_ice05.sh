...
# train
python main.py -d ICEWS05_15 --history_len 2 --num_head 1 --num_ly 1 --topk 50 --decay 1e-4 --gpu 2 --test 0

# test
python main.py -d ICEWS05_15 --history_len 2 --num_head 1 --num_ly 1 --topk 50 --decay 1e-4 --gpu 2 --test 1
