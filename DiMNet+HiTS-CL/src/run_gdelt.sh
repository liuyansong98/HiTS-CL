...
# online train valid
python main.py -d GDELT --history_len 5 --num_head 1 --num_ly 3 --topk 50 --decay 1e-4 --gpu 2 --test 2 \
--temperature 2 --distill_weight 1 --con_description continual_learning

# online train test
python main.py -d GDELT --history_len 5 --num_head 1 --num_ly 3 --topk 50 --decay 1e-4 --gpu 2 --test 3 \
--temperature 2 --distill_weight 1 --con_description continual_learning
